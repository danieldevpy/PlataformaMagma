...
(function () {
  ...
  // Provedores conhecidos pelo model (ProvedorIA.Provedor) — só anthropic/openai
  // por enquanto (ver docs/subsistemas/10-studio-2.0.md §5.5).
  const PROVEDORES_OPCOES = [
    { valor: 'anthropic', label: 'Anthropic' },
    { valor: 'openai', label: 'OpenAI' },
  ];
  const MODELO_SUGERIDO = { anthropic: 'claude-sonnet-5', openai: 'gpt-4o-mini' };
